...
def controllerMellingerFirmwareInit():
    return _cffirmware.controllerMellingerFirmwareInit()

def controllerMellingerFirmwareTest():
    return _cffirmware.controllerMellingerFirmwareTest()

def controllerMellingerFirmware(control, setpoint, sensors, state, stabilizerStep):
    return _cffirmware.controllerMellingerFirmware(control, setpoint, sensors, state, stabilizerStep)
...
class Axis3fSubSampler_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    sum = property(_cffirmware.Axis3fSubSampler_t_sum_get, _cffirmware.Axis3fSubSampler_t_sum_set)
    count = property(_cffirmware.Axis3fSubSampler_t_count_get, _cffirmware.Axis3fSubSampler_t_count_set)
    conversionFactor = property(_cffirmware.Axis3fSubSampler_t_conversionFactor_get, _cffirmware.Axis3fSubSampler_t_conversionFactor_set)
    subSample = property(_cffirmware.Axis3fSubSampler_t_subSample_get, _cffirmware.Axis3fSubSampler_t_subSample_set)

    def __init__(self):
        _cffirmware.Axis3fSubSampler_t_swiginit(self, _cffirmware.new_Axis3fSubSampler_t())
    __swig_destroy__ = _cffirmware.delete_Axis3fSubSampler_t

# Register Axis3fSubSampler_t in _cffirmware:
_cffirmware.Axis3fSubSampler_t_swigregister(Axis3fSubSampler_t)

def axis3fSubSamplerInit(this, conversionFactor):
    return _cffirmware.axis3fSubSamplerInit(this, conversionFactor)

def axis3fSubSamplerAccumulate(this, sample):
    return _cffirmware.axis3fSubSamplerAccumulate(this, sample)

def axis3fSubSamplerFinalize(this):
    return _cffirmware.axis3fSubSamplerFinalize(this)
class OutlierFilterTdoaState_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    integrator = property(_cffirmware.OutlierFilterTdoaState_t_integrator_get, _cffirmware.OutlierFilterTdoaState_t_integrator_set)
    latestUpdateMs = property(_cffirmware.OutlierFilterTdoaState_t_latestUpdateMs_get, _cffirmware.OutlierFilterTdoaState_t_latestUpdateMs_set)
    isFilterOpen = property(_cffirmware.OutlierFilterTdoaState_t_isFilterOpen_get, _cffirmware.OutlierFilterTdoaState_t_isFilterOpen_set)

    def __init__(self):
        _cffirmware.OutlierFilterTdoaState_t_swiginit(self, _cffirmware.new_OutlierFilterTdoaState_t())
    __swig_destroy__ = _cffirmware.delete_OutlierFilterTdoaState_t

# Register OutlierFilterTdoaState_t in _cffirmware:
_cffirmware.OutlierFilterTdoaState_t_swigregister(OutlierFilterTdoaState_t)

def outlierFilterTdoaReset(this):
    return _cffirmware.outlierFilterTdoaReset(this)

def outlierFilterTdoaValidateIntegrator(this, tdoa, error, nowMs):
    return _cffirmware.outlierFilterTdoaValidateIntegrator(this, tdoa, error, nowMs)
KC_STATE_X = _cffirmware.KC_STATE_X
KC_STATE_Y = _cffirmware.KC_STATE_Y
KC_STATE_Z = _cffirmware.KC_STATE_Z
KC_STATE_PX = _cffirmware.KC_STATE_PX
KC_STATE_PY = _cffirmware.KC_STATE_PY
KC_STATE_PZ = _cffirmware.KC_STATE_PZ
KC_STATE_D0 = _cffirmware.KC_STATE_D0
KC_STATE_D1 = _cffirmware.KC_STATE_D1
KC_STATE_D2 = _cffirmware.KC_STATE_D2
KC_STATE_DIM = _cffirmware.KC_STATE_DIM
class kalmanCoreData_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    S = property(_cffirmware.kalmanCoreData_t_S_get, _cffirmware.kalmanCoreData_t_S_set)
    q = property(_cffirmware.kalmanCoreData_t_q_get, _cffirmware.kalmanCoreData_t_q_set)
    R = property(_cffirmware.kalmanCoreData_t_R_get, _cffirmware.kalmanCoreData_t_R_set)
    P = property(_cffirmware.kalmanCoreData_t_P_get, _cffirmware.kalmanCoreData_t_P_set)
    Pm = property(_cffirmware.kalmanCoreData_t_Pm_get, _cffirmware.kalmanCoreData_t_Pm_set)
    baroReferenceHeight = property(_cffirmware.kalmanCoreData_t_baroReferenceHeight_get, _cffirmware.kalmanCoreData_t_baroReferenceHeight_set)
    initialQuaternion = property(_cffirmware.kalmanCoreData_t_initialQuaternion_get, _cffirmware.kalmanCoreData_t_initialQuaternion_set)
    isUpdated = property(_cffirmware.kalmanCoreData_t_isUpdated_get, _cffirmware.kalmanCoreData_t_isUpdated_set)
    lastPredictionMs = property(_cffirmware.kalmanCoreData_t_lastPredictionMs_get, _cffirmware.kalmanCoreData_t_lastPredictionMs_set)
    lastProcessNoiseUpdateMs = property(_cffirmware.kalmanCoreData_t_lastProcessNoiseUpdateMs_get, _cffirmware.kalmanCoreData_t_lastProcessNoiseUpdateMs_set)

    def __init__(self):
        _cffirmware.kalmanCoreData_t_swiginit(self, _cffirmware.new_kalmanCoreData_t())
    __swig_destroy__ = _cffirmware.delete_kalmanCoreData_t

# Register kalmanCoreData_t in _cffirmware:
_cffirmware.kalmanCoreData_t_swigregister(kalmanCoreData_t)
class kalmanCoreParams_t(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    stdDevInitialPosition_xy = property(_cffirmware.kalmanCoreParams_t_stdDevInitialPosition_xy_get, _cffirmware.kalmanCoreParams_t_stdDevInitialPosition_xy_set)
    stdDevInitialPosition_z = property(_cffirmware.kalmanCoreParams_t_stdDevInitialPosition_z_get, _cffirmware.kalmanCoreParams_t_stdDevInitialPosition_z_set)
    stdDevInitialVelocity = property(_cffirmware.kalmanCoreParams_t_stdDevInitialVelocity_get, _cffirmware.kalmanCoreParams_t_stdDevInitialVelocity_set)
    stdDevInitialAttitude_rollpitch = property(_cffirmware.kalmanCoreParams_t_stdDevInitialAttitude_rollpitch_get, _cffirmware.kalmanCoreParams_t_stdDevInitialAttitude_rollpitch_set)
    stdDevInitialAttitude_yaw = property(_cffirmware.kalmanCoreParams_t_stdDevInitialAttitude_yaw_get, _cffirmware.kalmanCoreParams_t_stdDevInitialAttitude_yaw_set)
    procNoiseAcc_xy = property(_cffirmware.kalmanCoreParams_t_procNoiseAcc_xy_get, _cffirmware.kalmanCoreParams_t_procNoiseAcc_xy_set)
    procNoiseAcc_z = property(_cffirmware.kalmanCoreParams_t_procNoiseAcc_z_get, _cffirmware.kalmanCoreParams_t_procNoiseAcc_z_set)
    procNoiseVel = property(_cffirmware.kalmanCoreParams_t_procNoiseVel_get, _cffirmware.kalmanCoreParams_t_procNoiseVel_set)
    procNoisePos = property(_cffirmware.kalmanCoreParams_t_procNoisePos_get, _cffirmware.kalmanCoreParams_t_procNoisePos_set)
    procNoiseAtt = property(_cffirmware.kalmanCoreParams_t_procNoiseAtt_get, _cffirmware.kalmanCoreParams_t_procNoiseAtt_set)
    measNoiseBaro = property(_cffirmware.kalmanCoreParams_t_measNoiseBaro_get, _cffirmware.kalmanCoreParams_t_measNoiseBaro_set)
    measNoiseGyro_rollpitch = property(_cffirmware.kalmanCoreParams_t_measNoiseGyro_rollpitch_get, _cffirmware.kalmanCoreParams_t_measNoiseGyro_rollpitch_set)
    measNoiseGyro_yaw = property(_cffirmware.kalmanCoreParams_t_measNoiseGyro_yaw_get, _cffirmware.kalmanCoreParams_t_measNoiseGyro_yaw_set)
    initialX = property(_cffirmware.kalmanCoreParams_t_initialX_get, _cffirmware.kalmanCoreParams_t_initialX_set)
    initialY = property(_cffirmware.kalmanCoreParams_t_initialY_get, _cffirmware.kalmanCoreParams_t_initialY_set)
    initialZ = property(_cffirmware.kalmanCoreParams_t_initialZ_get, _cffirmware.kalmanCoreParams_t_initialZ_set)
    initialYaw = property(_cffirmware.kalmanCoreParams_t_initialYaw_get, _cffirmware.kalmanCoreParams_t_initialYaw_set)

    def __init__(self):
        _cffirmware.kalmanCoreParams_t_swiginit(self, _cffirmware.new_kalmanCoreParams_t())
    __swig_destroy__ = _cffirmware.delete_kalmanCoreParams_t

# Register kalmanCoreParams_t in _cffirmware:
_cffirmware.kalmanCoreParams_t_swigregister(kalmanCoreParams_t)

def kalmanCoreDefaultParams(params):
    return _cffirmware.kalmanCoreDefaultParams(params)

def kalmanCoreInit(this, params, nowMs):
    return _cffirmware.kalmanCoreInit(this, params, nowMs)

def kalmanCoreUpdateWithBaro(this, params, baroAsl, quadIsFlying):
    return _cffirmware.kalmanCoreUpdateWithBaro(this, params, baroAsl, quadIsFlying)

def kalmanCorePredict(this, acc, gyro, nowMs, quadIsFlying):
    return _cffirmware.kalmanCorePredict(this, acc, gyro, nowMs, quadIsFlying)

def kalmanCoreAddProcessNoise(this, params, nowMs):
    return _cffirmware.kalmanCoreAddProcessNoise(this, params, nowMs)

def kalmanCoreFinalize(this):
    return _cffirmware.kalmanCoreFinalize(this)

def kalmanCoreExternalizeState(this, state, acc):
    return _cffirmware.kalmanCoreExternalizeState(this, state, acc)

def kalmanCoreDecoupleXY(this):
    return _cffirmware.kalmanCoreDecoupleXY(this)

def kalmanCoreScalarUpdate(this, Hm, error, stdMeasNoise):
    return _cffirmware.kalmanCoreScalarUpdate(this, Hm, error, stdMeasNoise)

def kalmanCoreUpdateWithPKE(this, Hm, Km, P_w_m, error):
    return _cffirmware.kalmanCoreUpdateWithPKE(this, Hm, Km, P_w_m, error)

def kalmanCoreUpdateWithTdoa(this, tdoa, nowMs, outlierFilterState):
    return _cffirmware.kalmanCoreUpdateWithTdoa(this, tdoa, nowMs, outlierFilterState)
